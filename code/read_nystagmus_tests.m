...
%%
% TODO
% separate reports alternative
% non calibrated
% section with best nystagmus
% frequency
% assesment data quality

if ismac % jose ossandon computer
    PATH = '/Users/jossando/trabajo/OPD/nystagmography/nystagmus_tests';
    outPATH = '/Users/jossando/trabajo/OPD/nystagmus_reports/reports';
else
...
trials_times.horizontal = [30,30,180];
trials_eyes.vertical    = {{'right'},{'left'},{'right','left'}};
trials_times.vertical   = [30,30,120];
